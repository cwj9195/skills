...
| --------- | ---- | -------- | -------- | ---------------------- | ------------------------ | -------- | ----------- | -------- | -------- | -------- | -------- |
| T-M{N}-01 | TODO | TODO     | TODO     | `需求说明.md#TODO` | `代码参考.md#TODO` | `../../接口契约.md#API-M{N}-TODO` / 无 | TODO        | TODO     | TODO     | TODO     | TODO     |
...
- `需求引用`：引用 需求说明.md 中真实存在的章节。
- `代码引用`：引用 代码参考.md 中真实存在的章节。
- `API 引用`：任务涉及接口时引用 `接口契约.md` 中真实存在的接口 ID；无接口任务写“无”。
